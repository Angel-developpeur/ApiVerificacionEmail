...
let AuthController = class AuthController {
    ...
    async validateCode(validateCodeDto) {
        const isValid = await this.authService.validateCode(validateCodeDto.email, validateCodeDto.code, validateCodeDto.apiToken);
        return { isValid };
    }
};
